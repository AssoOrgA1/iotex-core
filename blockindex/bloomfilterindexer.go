...
func (bfx *bloomfilterIndexer) Start(ctx context.Context) error {
	...
	case nil:
		...
		if err = bfx.initRangeBloomFilter(tipHeight); err != nil {
			return err
		}
	case db.ErrNotExist:
		if err = bfx.kvStore.Put(RangeBloomFilterNamespace, []byte(CurrentHeightKey), make([]byte, 8)); err != nil {
			return err
		}
		if err = bfx.initRangeBloomFilter(0); err != nil {
			return err
		}
	default:
		return err
